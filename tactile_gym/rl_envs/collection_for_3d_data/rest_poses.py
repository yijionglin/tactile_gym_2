        ...
        "tactip": {
            "standard": np.array(
                [
                    ...
                    0.15290267533998175,  # base_joint       (revolute)
                    -2.017762819637276,  # shoulder_joint  (revolute)
                    -1.3668112003615653,  # elbow_joint     (revolute)
                    -1.2833263179994592,  # wrist_1_joint   (revolute)
                    1.6317415328888156,  # wrist_2_joint    (revolute)
                    1.8044704625610863,  # wrist_3_joint    (revolute)
                    0.00,  # ee_joint            (fixed)
