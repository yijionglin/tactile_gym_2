from tactile_gym.rl_envs.demo_data_collect_for_3d_env import demo_rl_env

from tactile_gym.rl_envs.collection_for_3d_data.collection_for_3d_data import (
    CollectionFor3DData,
)
...
def main():
    ...
    if show_gui:
        ...
        elif env_modes["movement_mode"] == "xyzRxRyRz":
            action_ids.append(
                env._pb.addUserDebugParameter("dX", min_action, max_action, 0)
            )
            action_ids.append(
